const User = require('../module/user'); // Import User Model Schema
const Blog = require('../module/blog'); // Import Blog Model Schema
...
module.exports = (router) => {
	...
	router.post('/newBlog', (req, res) => {
      ...
      console.log ("inside title");
        ...
        console.log ("inside professorName");
				res.json({
					success: false,
		...
		if (!req.body._id) {
			...
			Blog.findOne({
				...
				if (err) {
                    ...
                    blog.title = req.body.professorName;// Save latest professorName
