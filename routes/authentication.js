...
module.exports = (router) => {
    ...
    router.post('/register', (req, res) => {
        if (!req.body.name) {
            res.json({ success: false, message: 'provide an name' });
        } else {
            if (!req.body.email) {
                ...
                if (!req.body.username) {
                    ...
                    if (!req.body.department) {
                        res.json({ success: false, message: 'select a department ' });
                    }
                    else {
                        if (!req.body.career) {
                            res.json({ success: false, message: 'select a career ' });
                        } else {
                            if (!req.body.yearOfGrad) {
                                res.json({ success: false, message: 'provide the year of expected graduation ' });
                            }
                            else {
                                if (!req.body.password) {
                                    ...
                                    let user = new User({
                                        ...
                                        career: req.body.career.toLowerCase(),
    ...
    router.get('/profile', (req, res) => {
        ...
        User.findOne({ _id: req.decoded.userId }).select('username email department name career yearOfGrad').exec((err, user) => {
